...
{
    public partial class PublicarResultadosINMP : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (Request["ID"] != null)
                {
                    ...
                    CargarGrilla(ensayoId, 1, string.Empty, string.Empty, 0, string.Empty);
                    CargarTipoResultado();
                }
                else
                {
        ...
        protected void btnFiltrar_Click(object sender, EventArgs e)
        {
            ...
            CargarGrilla(idEnsayo, 1, operador, concentracion, tipoResultado, codigo);
        }
        ...
        private void CargarGrilla(int EnsayoId, int estado, string operador, string concentracion, int tipoResultado, string codigoCorrelativo)
        {
            List<Vista_ResultadosGSP> listaResultados = resultadoBC.ObtenerResultadosPublicacion(EnsayoId, operador, concentracion, tipoResultado, codigoCorrelativo,"2");
