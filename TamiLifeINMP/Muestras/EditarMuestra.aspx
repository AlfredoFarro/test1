<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="EditarMuestra.aspx.cs" Inherits="TamiLifeSA.Muestras.EditarMuestra" %>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td class="filaDelgada" colspan="2">
                                ...
                                <asp:HiddenField ID="hdnCodigoCorrelativo" runat="server" />
                                <asp:HiddenField ID="hdnIdMuestra" runat="server" />
                                <asp:HiddenField ID="hdnExisteMuestra" runat="server" Value="0" />
                                <asp:HiddenField ID="hdnExisteCorrelativo" runat="server" Value="0" />
                                <asp:HiddenField ID="hdnPaginaProcedencia" runat="server" Value="1" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                &nbsp;<asp:Button ID="btnIngresar" runat="server" CssClass="BotonAccion" OnClick="btnIngresar_Click"
                                    Text="Ingresar" ValidationGroup="dni" />
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:MaskedEditValidator ID="txtHoraNacimiento_MaskedEV" runat="server" ControlExtender="txtHoraNacimiento_MaskedEditExtender"
                                    ...
                                    IsValidEmpty="False" TooltipMessage="" ValidationGroup="validadores">*</asp:MaskedEditValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="columnaEtiquetas">
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td class="filaDelgada" colspan="5">
                                <asp:TextBox ID="txtHClinica" runat="server" CssClass="textoMedio" Visible="False"></asp:TextBox>
                                ...
                                <asp:TextBox ID="txtCelular" runat="server" CssClass="textoCorto" MaxLength="12"
                                    Visible="False"></asp:TextBox>
                                <asp:FilteredTextBoxExtender ID="txtCelular_FilteredTextBoxExtender" runat="server"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNMuestra" runat="server" CssClass="textoMini"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="columnaEtiquetas">
                            ...
                            <td>
                                ...
                                <asp:MaskedEditValidator ID="txtHoraToma_MaskedEV" runat="server" ControlExtender="txtHoraToma_MaskedEditExtender"
                                    ...
                                    EmptyValueBlurredText="*" EmptyValueMessage="Ingrese la Hora de Toma"
                                    Font-Bold="True" ForeColor="Red" InvalidValueBlurredMessage="*" InvalidValueMessage="Ingrese una Hora de Toma valida"
                                    IsValidEmpty="False" TooltipMessage="" ValidationGroup="val">*</asp:MaskedEditValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="columnaEtiquetas">
