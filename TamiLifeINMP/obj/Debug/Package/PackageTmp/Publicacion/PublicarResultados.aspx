<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="PublicarResultados.aspx.cs" Inherits="TamiLifeSA.Publicacion.PublicarResultados" %>
    ...
    <div id="DivPrincipal">
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="lblFechaResultado" runat="server" Text="FechaResultado" 
            ...
            <tr>
                <td class="columnaEtiquetas">
                    <asp:Label ID="lblTipoResultado" runat="server" Text="Tipo Resultado:" 
                ...
                <td class="columnaEtiquetas">
                    <asp:Label ID="lblCodigoCorrelativo" runat="server" Text="Código Correlativo:" 
                        Visible="False"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtCodigoCorrelativo" runat="server" CssClass="textoMedio" 
                        MaxLength="9"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="columnaEtiquetas">
                    <asp:Label ID="lblPublicado" runat="server" Text="Publicado:" 
                        Visible="False"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td class="SubTituloTabla1" colspan="4">
                    Resultados
                    <asp:DropDownList ID="ddlOperador" runat="server" CssClass="textoMini" 
                        Visible="False">
                    ...
                    <asp:TextBox ID="txtConcentracion" runat="server" CssClass="textoMini" 
                        onkeypress="return isFloatNumber(this,event);" Visible="False"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td colspan="4">
