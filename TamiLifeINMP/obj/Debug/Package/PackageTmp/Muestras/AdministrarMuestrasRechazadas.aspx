<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdministrarMuestrasRechazadas.aspx.cs" Inherits="TamiLifeSA.Muestras.AdministrarMuestrasRechazadas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h1>
        Administrar Muestras Rechazadas</h1>
    ...
    <div id="DivPrincipal" runat="server">
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtCorrelativo" runat="server" CssClass="textoMedio" MaxLength="9"></asp:TextBox>
                    <asp:FilteredTextBoxExtender ID="txtCorrelativo_FilteredTextBoxExtender" runat="server"
                        Enabled="True" FilterType="Numbers" TargetControlID="txtCorrelativo"></asp:FilteredTextBoxExtender>
                    </td>
            </tr>
            <tr>
                <td class="columnaEtiquetas">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtFechaInicioRecepcion" runat="server" CssClass="textoMedio" Width="95px"></asp:TextBox>
                    <ajaxToolkit:FilteredTextBoxExtender ID="txtFechaInicioRecepcion_FilteredTextBoxExtender"
                        runat="server" BehaviorID="txtFechaInicioRecepcion_FilteredTextBoxExtender" FilterType="Custom,Numbers"
                        ValidChars="/" TargetControlID="txtFechaInicioRecepcion"></ajaxToolkit:FilteredTextBoxExtender>
                    <ajaxToolkit:CalendarExtender ID="txtFechaInicioRecepcion_CalendarExtender" Format="dd/MM/yyyy"
                        runat="server" BehaviorID="txtFechaInicioRecepcion_CalendarExtender" TargetControlID="txtFechaInicioRecepcion">
                    </ajaxToolkit:CalendarExtender>
                    -
                    <asp:TextBox ID="txtFechaFinRecepcion" runat="server" CssClass="textoMedio" Width="95px"></asp:TextBox>
                    <ajaxToolkit:FilteredTextBoxExtender ID="txtFechaFinRecepcion_FilteredTextBoxExtender" runat="server"
                        BehaviorID="txtFechaFinRecepcion_FilteredTextBoxExtender" FilterType="Custom,Numbers"
                        ValidChars="/" TargetControlID="txtFechaFinRecepcion"></ajaxToolkit:FilteredTextBoxExtender>
                    <ajaxToolkit:CalendarExtender ID="txtFechaFinRecepcion_CalendarExtender" runat="server" Format="dd/MM/yyyy"
                        BehaviorID="txtFechaFinRecepcion_CalendarExtender" TargetControlID="txtFechaFinRecepcion">
                    </ajaxToolkit:CalendarExtender>
                </td>
            </tr>
            <tr>
