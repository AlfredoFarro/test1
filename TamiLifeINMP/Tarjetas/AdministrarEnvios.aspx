<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdministrarEnvios.aspx.cs" Inherits="TamizajePortal.Tarjetas.AdministrarEnvios" %>
            ...
            <ContentTemplate>
                ...
                <asp:GridView ID="dgvResultados" runat="server" AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanging="dgvResultados_PageIndexChanging" PageSize="20" OnRowCommand="dgvResultados_RowCommand">
                     <Columns>
                                    ...
                                    <asp:BoundField DataField="idEnvio" HeaderText="idEnvio" Visible="False">
                                    <ItemStyle Width="60px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Establecimiento" HeaderText="Establecimiento" >
                                    <ItemStyle Width="300px"/>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="FechaEnvio" HeaderText="Fecha Envio" DataFormatString="{0:dd/MM/yy}" >
                                    ...
                                    <asp:TemplateField HeaderText="Editar">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="imgVer" runat="server" CommandArgument='<%# Eval("idEnvio") %>' CommandName="Editar" Height="15px" ImageUrl="~/images/gtk-edit.png" Width="15px" />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" Width="40px" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Eliminar">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="imgEli" runat="server" Visible='<%# Eval("TieneRecepciones") %>' Enabled='<%# Eval("TieneRecepciones") %>' CommandArgument='<%# Eval("idEnvio") %>' CommandName="Eliminar" Height="15px" ImageUrl="~/images/delete.png" Width="15px" />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" Width="40px" />
                                    </asp:TemplateField>
